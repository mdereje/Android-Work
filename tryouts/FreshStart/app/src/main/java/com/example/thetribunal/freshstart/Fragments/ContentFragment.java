...
//TODO: Need to replace the Friends and Statistics Tab.
...
public class ContentFragment extends Fragment {
     ...
     */
    public static ContentFragment newInstance(int position, CharSequence title, int indicatorColor,
                                              int dividerColor) {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (args != null) {
            TextView position = (TextView) view.findViewById(R.id.item_position);
            position.setText("Position: " + args.getInt(KEY_POSITION));
